...
End Function
'@@@@ old old old
'Public Function ExpandEnv(ByVal Text As String) As String
'    Dim lngNeeded As Long
'
'    lngNeeded = ExpandEnvironmentStrings(Text, ExpandEnv, 0)
'    ExpandEnv = String(lngNeeded, 0)
'    ExpandEnvironmentStrings Text, ExpandEnv, Len(ExpandEnv)
