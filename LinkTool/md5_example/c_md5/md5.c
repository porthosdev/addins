...
//this uses 3 VCRT api: strlen, memcpy, memset 
//make sure to use static library so these get compiled into obj file
...
#pragma EXPORT
	...
	//bufout must have space pre allocated to receive binary hash (16 bytes)
	//unsigned char digest[16];
	struct MD5_CTX context;
	MD5_Init(&context);
	MD5_Update(&context, sIn, strlen(sIn));
	MD5_Final(bufOut, &context);
